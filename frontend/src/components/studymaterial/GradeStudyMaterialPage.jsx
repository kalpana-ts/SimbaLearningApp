...
export default function GradeStudyMaterialPage() {
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'Math'} }} >
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'Social Study'} }} >
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'Science'} }} >
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'General Knowledge'} }} >
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'Language'} }} >
        ...
        <div class="subject_item">
          <div class="body">
            <div class="cp_img">
              ...
              <Link className="" to={{ pathname: `/studymaterial/grade/subject/${subject}`, state: {grade,subject:'Art'} }} >
